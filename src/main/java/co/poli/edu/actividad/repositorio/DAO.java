...
public class DAO implements CRUD<Pasaporte> {
    ...
    public Boolean insertar(Pasaporte pasaporte) {
        String sqlPasaporte = "INSERT INTO Pasaporte (idPasaporte, identificacionTitular, idPais, fechaExpedicion) VALUES (?,?,?,?)";
        ...
        try (Connection conn = SingletonBD.getConnection()) {
            ...
            try (PreparedStatement st = conn.prepareStatement(sqlPasaporte)) {
                ...
                st.setString(2, pasaporte.getTitular() != null ? pasaporte.getTitular().getIdentificacion() : null);
    ...
    public String actualizar(String id, Pasaporte pasaporte) {
        String sqlPasaporte = "UPDATE Pasaporte SET identificacionTitular=?, idPais=?, fechaExpedicion=? WHERE idPasaporte=?";
        ...
        try (Connection conn = SingletonBD.getConnection()) {
            ...
            try (PreparedStatement st = conn.prepareStatement(sqlPasaporte)) {
                st.setString(1, pasaporte.getTitular() != null ? pasaporte.getTitular().getIdentificacion() : null);
    ...
    public Pasaporte Search(String id) {
        String sqlPasaporte = "SELECT idPasaporte, identificacionTitular, idPais, fechaExpedicion FROM Pasaporte WHERE idPasaporte=?";
        ...
        try (Connection conn = SingletonBD.getConnection()) {
            ...
            String identificacionTitular = null;
            String idPais = null;
            ...
            try (PreparedStatement st = conn.prepareStatement(sqlPasaporte)) {
                ...
                try (ResultSet rs = st.executeQuery()) {
                    if (rs.next()) {
                        ...
                        identificacionTitular = rs.getString("identificacionTitular");
            ...
            try (PreparedStatement st = conn.prepareStatement(sqlOrdinario)) {
                ...
                try (ResultSet rs = st.executeQuery()) {
                    if (rs.next()) {
                        ...
                        po.setTitular(new Titular("Desconocido", identificacionTitular != null ? identificacionTitular : ""));
            ...
            try (PreparedStatement st = conn.prepareStatement(sqlDiplomatico)) {
                ...
                try (ResultSet rs = st.executeQuery()) {
                    if (rs.next()) {
                        ...
                        pd.setTitular(new Titular("Desconocido", identificacionTitular != null ? identificacionTitular : ""));
